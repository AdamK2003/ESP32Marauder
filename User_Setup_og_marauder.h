...
// RPI_ILI9486_DRIVER // 20MHz maximum SPI #define HX8357D_DRIVER #define
// ILI9481_DRIVER #define ILI9486_DRIVER #define ILI9488_DRIVER     // WARNING:
// Do not connect ILI9488 display SDO to MISO if other devices share the SPI bus
//(TFT SDO does NOT tristate when CS is high) #define ST7789_DRIVER      // Full
// configuration option, define additional parameters below for this display
...
// RM68140_DRIVER #define ST7796_DRIVER
...
// portrait orientation #define TFT_WIDTH  80 #define TFT_WIDTH  128 // Marauder
// Mini #define TFT_WIDTH  240 // ST7789 240 x 240 and 240 x 320 #define
// TFT_HEIGHT 160 #define TFT_HEIGHT 128 // Marauder Mini #define TFT_HEIGHT 240
// // ST7789 240 x 240 #define TFT_HEIGHT 320 // ST7789 240 x 320
...
#define SPI_FREQUENCY                                                          \
  55000000 // Marauder // Actually sets it to 26.67MHz = 80/3
